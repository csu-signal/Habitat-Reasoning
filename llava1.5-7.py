...
if __name__ == "__main__":
    ...
    df_syn = pd.DataFrame(selected_rows, columns=['Questions', 'Your_Answer'], index=custom_index)
...
df_testing_renamed['Questions'] = df_testing_renamed['Questions'].apply(modification)
...
df['habitat-2'].apply(extract_word)
